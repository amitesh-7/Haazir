  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-3 sm:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* PRIORITY: Smart Attendance Scanner - Moved to TOP for easy mobile access */}
        <div className="mb-4 sm:mb-8">
          <button
            onClick={() => history.push("/student/smart-attendance")}
            className="w-full bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 hover:from-green-600 hover:via-emerald-600 hover:to-teal-600 text-white rounded-2xl p-4 sm:p-6 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98]"
          >
        ...
        {/* Face Enrollment Alert - Show if not enrolled */}
        {!faceEnrollmentStatus.isEnrolled && (
          <div className="mb-4 sm:mb-8">
            <button
              onClick={() => history.push("/student/face-enrollment")}
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-6 mb-4 sm:mb-8">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4 sm:mb-6">
                ...
                <div className="flex flex-wrap gap-2 sm:gap-3">
                  <Link
                    ...
                    className="px-3 sm:px-4 py-2 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-lg hover:from-purple-600 hover:to-indigo-600 font-medium transition-all shadow-md hover:shadow-lg text-sm sm:text-base"
                  >
                    📊 Analytics
                  </Link>
                  <Link
                    to="/student/attendance"
                    className="text-blue-600 hover:text-blue-700 font-medium transition-colors flex items-center text-sm sm:text-base"
                  >
                    History →
                  </Link>
                </div>
