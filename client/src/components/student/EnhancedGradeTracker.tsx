    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-100 p-3 sm:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-4 sm:mb-8">
          ...
          <p className="text-gray-600 text-sm sm:text-lg">Track your academic performance and progress</p>
        </div>
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl sm:text-3xl font-bold text-green-600">{overallStats.overallGPA}</p>
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl sm:text-3xl font-bold text-blue-600">{overallStats.totalCredits}</p>
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl sm:text-3xl font-bold text-purple-600">{overallStats.totalCourses}</p>
          ...
          <div className="space-y-4 sm:space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
              {semesterSummaries.map(semester => (
                <div key={`${semester.semester}_${semester.academic_year}`} className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6">
                  ...
                  <div className="grid grid-cols-3 gap-2 sm:gap-4 text-center mb-3 sm:mb-4">
                    <div>
                      <div className="text-base sm:text-lg font-semibold text-blue-600">{semester.total_courses}</div>
                      <div className="text-xs text-gray-500">Courses</div>
                    </div>
                    <div>
                      <div className="text-base sm:text-lg font-semibold text-green-600">{semester.total_credits}</div>
                      <div className="text-xs text-gray-500">Credits</div>
                    </div>
                    <div>
                      <div className="text-base sm:text-lg font-semibold text-indigo-600">{semester.completed_courses}</div>
                  ...
                  <div className="space-y-2">
                    {semester.courses.slice(0, 3).map(course => (
                      <div key={course.course_id} className="flex items-center justify-between p-2 bg-gray-50 rounded-lg">
                        ...
                        <div className={`px-2 py-1 rounded-lg text-xs font-semibold border flex-shrink-0 ml-2 ${getGradeColor(course.current_grade)}`}>
        ...
        {selectedView === 'courses' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6">
            {courseGrades.map(course => (
              <div key={course.course_id} className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6">
                <div className="flex items-start justify-between mb-3 sm:mb-4">
                  <div className="min-w-0 flex-1">
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-1">
                      {course.course_code}
                    </h3>
                    <p className="text-xs sm:text-sm text-gray-600 line-clamp-2">{course.course_name}</p>
                    <p className="text-xs text-gray-500 mt-1">
                      {course.semester} {course.academic_year} • {course.credits} cr
                    </p>
                  </div>
                  <div className={`px-2 sm:px-3 py-1 sm:py-2 rounded-xl text-base sm:text-lg font-bold border flex-shrink-0 ml-2 ${getGradeColor(course.current_grade)}`}>
                    {course.current_grade}
                  </div>
                </div>
        ...
        {selectedView === 'assignments' && (
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl overflow-hidden">
            <div className="p-4 sm:p-6">
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4 sm:mb-6">Assignment History</h3>
                ...
                {filteredData.map(record => (
                  <div key={record.id} className="border border-gray-200 rounded-lg p-3">
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <div className={`px-2 py-1 rounded-lg text-xs font-semibold border ${getGradeColor(record.grade)}`}>
                        {record.grade}
                      </div>
                    </div>
                    <div className="flex justify-between items-center text-xs text-gray-600">
                      <span className="bg-gray-100 px-2 py-0.5 rounded capitalize">{record.assignment_type}</span>
                      <span>{record.marks_obtained}/{record.total_marks} ({record.percentage}%)</span>
                    </div>
        ...
        {selectedView === 'analytics' && (
          <div className="space-y-4 sm:space-y-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8">
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6">
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4 sm:mb-6">Grade Distribution</h3>
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6">
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4 sm:mb-6">Performance Trend</h3>
                <div className="h-48 sm:h-64">
                  <Line 
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6">
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4 sm:mb-6">Performance Insights</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6">
                <div className="text-center p-3 sm:p-4 bg-green-50 rounded-xl">
                  <div className="text-xl sm:text-2xl mb-1 sm:mb-2">🎯</div>
                  <div className="text-xs sm:text-sm font-medium text-green-800">Strongest Subject</div>
                ...
                <div className="text-center p-3 sm:p-4 bg-blue-50 rounded-xl">
                  <div className="text-xl sm:text-2xl mb-1 sm:mb-2">📈</div>
                  <div className="text-xs sm:text-sm font-medium text-blue-800">Average Improvement</div>
